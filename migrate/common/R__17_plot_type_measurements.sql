...
CREATE VIEW v_plot_bullseye_measurement AS (
  ...
  LEFT JOIN timeseries_measurement xm ON xm.timeseries_id = pc.x_axis_timeseries_id
  LEFT JOIN timeseries_measurement ym ON ym.timeseries_id = pc.y_axis_timeseries_id
);
...
CREATE VIEW v_plot_contour_measurement AS (
  ...
  LEFT JOIN timeseries_measurement mm ON mm.timeseries_id = ts.id
