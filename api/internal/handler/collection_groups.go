...
func (h ApiHandler) ListCollectionGroups(c echo.Context) error {
	...
	cc, err := h.CollectionGroupStore.ListCollectionGroups(c.Request().Context(), pID)
	if err != nil {
...
func (h ApiHandler) GetCollectionGroupDetails(c echo.Context) error {
	...
	d, err := h.CollectionGroupStore.GetCollectionGroupDetails(c.Request().Context(), pID, cgID)
	if err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, err.Error())
	}
...
func (h ApiHandler) CreateCollectionGroup(c echo.Context) error {
	...
	slugsTaken, err := h.CollectionGroupStore.ListCollectionGroupSlugs(c.Request().Context(), pID)
	if err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, err.Error())
	}
	...
	cgNew, err := h.CollectionGroupStore.CreateCollectionGroup(c.Request().Context(), cg)
	if err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, err.Error())
	}
...
func (h ApiHandler) UpdateCollectionGroup(c echo.Context) error {
	...
	cgUpdated, err := h.CollectionGroupStore.UpdateCollectionGroup(c.Request().Context(), cg)
	if err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, err.Error())
	}
...
func (h ApiHandler) DeleteCollectionGroup(c echo.Context) error {
	...
	if err := h.CollectionGroupStore.DeleteCollectionGroup(c.Request().Context(), pID, cgID); err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, err.Error())
	}
...
func (h ApiHandler) AddTimeseriesToCollectionGroup(c echo.Context) error {
	...
	if err := h.CollectionGroupStore.AddTimeseriesToCollectionGroup(c.Request().Context(), cgID, tsID); err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, err.Error())
	}
	return c.JSON(http.StatusOK, make(map[string]interface{}))
}
...
func (h ApiHandler) RemoveTimeseriesFromCollectionGroup(c echo.Context) error {
	...
	if err := h.CollectionGroupStore.RemoveTimeseriesFromCollectionGroup(c.Request().Context(), cgID, tsID); err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, err.Error())
	}
	return c.JSON(http.StatusOK, make(map[string]interface{}))
}
