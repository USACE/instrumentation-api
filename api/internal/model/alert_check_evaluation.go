...
func (a AlertConfigEvaluationCheck) GetAlertConfigScheduler() AlertConfigScheduler {
	return a.AlertConfig
}

func (a *AlertConfigEvaluationCheck) SetAlertConfigScheduler(ac AlertConfigScheduler) {
	a.AlertConfig = ac
}
