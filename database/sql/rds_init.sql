-- Add PostGIS Database Extensions to Postgres
-- Makes Plain Amazon Web Services (AWS) postgres database into a PostGIS database
...
-- Add tiger schema to path
ALTER DATABASE postgres SET search_path=public,tiger;
