...
func main() {
	...
	private.PUT("/calculations", handlers.UpdateComputation(db))
	public.GET("/calculations/:instrument_id", handlers.GetComputations(db))
	private.DELETE("/calculations/:computation_id", handlers.DeleteComputation(db))
