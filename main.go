...
func main() {
	...
	public.GET("/:project_id/plot_configurations", handlers.ListPlotConfigurations(db))
	public.GET("/:project_id/plot_configurations/:plot_configuration_id", handlers.GetPlotConfiguration(db))
