...
DROP DATABASE midas_develop;
--
-- Name: midas_develop; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE midas_develop WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.UTF-8';


ALTER DATABASE midas_develop OWNER TO postgres;

\connect midas_develop
...
--
-- Name: midas_develop; Type: DATABASE PROPERTIES; Schema: -; Owner: postgres
--

ALTER DATABASE midas_develop SET search_path TO '$user', 'public', 'topology';
...
--
-- Name: plot_configuration_settings; Type: TABLE; Schema: midas; Owner: postgres
--

CREATE TABLE midas.plot_configuration_settings (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
...
ALTER TABLE midas.plot_configuration_settings OWNER TO postgres;
...
SELECT
    ...
    NULL::uuid AS project_id,
    NULL::uuid[] AS timeseries_id,
    NULL::uuid AS creator,
    NULL::timestamp with time zone AS create_date,
    NULL::uuid AS updater,
    NULL::timestamp with time zone AS update_date,
    NULL::boolean AS show_masked,
    NULL::boolean AS show_nonvalidated,
    NULL::boolean AS show_comments;
...
--
-- Name: plot_configuration_settings plot_configuration_settings_pkey; Type: CONSTRAINT; Schema: midas; Owner: postgres
--

ALTER TABLE ONLY midas.plot_configuration_settings
    ADD CONSTRAINT plot_configuration_settings_pkey PRIMARY KEY (id);
...
--
-- Name: v_plot_configuration _RETURN; Type: RULE; Schema: midas; Owner: postgres
--

CREATE OR REPLACE VIEW midas.v_plot_configuration AS
 SELECT pc.id,
    pc.slug,
    pc.name,
    pc.project_id,
   ...
   FROM ((public.plot_configuration pc
     ...
     LEFT JOIN ( SELECT plot_configuration_settings.id,
            plot_configuration_settings.show_masked,
            plot_configuration_settings.show_nonvalidated,
            plot_configuration_settings.show_comments
           FROM midas.plot_configuration_settings
          GROUP BY plot_configuration_settings.id) k ON ((pc.id = k.id)));
...
--
-- Name: plot_configuration_settings plot_configuration_settings_id_fkey; Type: FK CONSTRAINT; Schema: midas; Owner: postgres
--

ALTER TABLE ONLY midas.plot_configuration_settings
    ADD CONSTRAINT plot_configuration_settings_id_fkey FOREIGN KEY (id) REFERENCES midas.plot_configuration(id);
...
--
-- Name: TABLE plot_configuration_settings; Type: ACL; Schema: midas; Owner: postgres
--

GRANT INSERT,DELETE,UPDATE ON TABLE midas.plot_configuration_settings TO instrumentation_writer;
GRANT SELECT ON TABLE midas.plot_configuration_settings TO instrumentation_reader;
...
GRANT INSERT,DELETE,UPDATE ON TABLE midas.v_plot_configuration TO instrumentation_writer;
